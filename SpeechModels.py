...
from keras.layers import Add, Dropout, BatchNormalization, Conv2D, Reshape, MaxPooling2D, Dense, LSTM, Bidirectional #,CuDNNLSTM
...
def ConvSpeechModel(nCategories, samplingrate = 16000, inputLength = 16000):
    ...
    c2 = Conv2D(60, (3,3) , activation='relu', padding='same') (p1)
    c2 = BatchNormalization() (c2)
    p2 = MaxPooling2D((2, 2)) (c2)
    p2 = Dropout(0.01) (p2)
    

    c3 = Conv2D(100, (3,3) , activation='relu', padding='same') (p2)
...
def AttRNNSpeechModel(nCategories, samplingrate = 16000, inputLength = 16000):
    ...
    #x = Bidirectional(CuDNNLSTM(64, return_sequences = True)) (x) # [b_s, seq_len, vec_dim] we don't have GPU
    #x = Bidirectional(CuDNNLSTM(64, return_sequences = True)) (x) # [b_s, seq_len, vec_dim] we don't have GPU
    ...
    x = Dense(32, activation = 'relu')(attVector)
    #x = Dense(32)(x)
